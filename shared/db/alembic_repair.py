...
def infer_alembic_revision(probe: SchemaProbe) -> str:
    ...
    if probe.column_exists("shared_db_xmonitorstate", "pending_tweet_id"):
        return "w3x4y5z6a7b8"
    if probe.table_exists("shared_db_xtarget"):
        return "v2w3x4y5z6a7"
    if probe.column_exists("shared_db_linkparsergrouppolicy", "send_video_enabled"):
        return "u1v2w3x4y5z6"
    if probe.table_exists("shared_db_rustrconcustomcommandalloweduser"):
        return "t0u1v2w3x4y5"
